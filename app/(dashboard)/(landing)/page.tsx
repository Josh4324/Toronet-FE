    ...
    <>
      <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
          ...
          <p className="max-w-[42rem]  leading-normal text-muted-foreground sm:text-xl sm:leading-8">
            Green Deeds, Bright Rewards: Cultivate a Greener World, One Action
            at a Time!
          </p>
        ...
        <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">Create Enviromental Actions</h3>
                <p className="text-sm text-muted-foreground">
                  These are Actions that help the environment
                </p>
              </div>
            </div>
          </div>
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm">
                  Points are awarded for Confirmed Enviromental Actions
                </p>
              </div>
            </div>
          </div>
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">Convert Point to Toro Coin</h3>
                <p className="text-sm text-muted-foreground">
                  Points can be swapped to Toro Coins
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">Actions History</h3>
                <p className="text-sm text-muted-foreground">
                  View all your Enviromental Actions
                </p>
              </div>
            </div>
          </div>
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">Impacts</h3>
                <p className="text-sm text-muted-foreground">
                  View the impacts you have done in your profile
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="open-source" className="container py-8 md:py-12 lg:py-24">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
          <h2 className="font-heading text-3xl leading-[1.1] sm:text-3xl md:text-6xl">
            Help Fund ECO4Reward
          </h2>
          <div className="space-x-4">
            <Link href="/fund" className={cn(buttonVariants({ size: "lg" }))}>
              Fund ECO4Reward
            </Link>
          </div>
        </div>
      ...
      <section id="open-source" className="container py-8 md:py-12 lg:py-24">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            ECO4Reward is open source and powered by open source software.{" "}
